...
type ClickBoardProps = {
  value: string;
  label?: string;
};

const ClickBoard: React.FC<ClickBoardProps> = ({ value, label = "Label" }) => {
    ...
    <div className="w-full max-w-[full]">
      <div className="relative">
        ...
        <input
          ...
          type="text"
          className="col-span-6 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full py-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
          value={label}
          disabled
          readOnly
        />
